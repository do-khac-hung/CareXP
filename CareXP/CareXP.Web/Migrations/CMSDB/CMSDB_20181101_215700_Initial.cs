...
namespace CareXP.Migrations.CMSDB
{

    [Migration(20181101215700)]
    public class CMSDB_20181101_215700_Initial : AutoReversingMigration
    {
        public override void Up()
        {
            IfDatabase("SqlServer", "SqlServer2000", "SqlServerCe")
              .Execute.EmbeddedScript
              (@"CareXP.Migrations.CMSDB.CMSDBScript_SqlServer.sql");
            /*
