...
namespace CareXP.Migrations.DefaultDB
{

    [Migration(20180827091900)]
    public class DefaultDB_20180827_091900_Initial : AutoReversingMigration
    {
        public override void Up()
        {
            IfDatabase("SqlServer", "SqlServer2000", "SqlServerCe")
              .Execute.EmbeddedScript
              (@"CareXP.Migrations.DefaultDB.DefaultDBScript_SqlServer.sql");
            /*
