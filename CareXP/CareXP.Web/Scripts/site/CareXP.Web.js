...
(function (CareXP) {
    ...
    })(Administration = CareXP.Administration || (CareXP.Administration = {}));
})(CareXP || (CareXP = {}));
var CareXP;
(function (CareXP) {
    var Administration;
...
(function (CareXP) {
    ...
    })(BasicSamples = CareXP.BasicSamples || (CareXP.BasicSamples = {}));
})(CareXP || (CareXP = {}));
var CareXP;
(function (CareXP) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = CareXP.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = CareXP.Northwind.OrderDetailsEditor;
...
(function (CareXP) {
    ...
    (function (CMS) {
        var PostsForm = /** @class */ (function (_super) {
            ...
            PostsForm.formKey = 'CMS.Posts';
            return PostsForm;
        }(Serenity.PrefixedContext));
        CMS.PostsForm = PostsForm;
    })(CMS = CareXP.CMS || (CareXP.CMS = {}));
})(CareXP || (CareXP = {}));
var CareXP;
(function (CareXP) {
    var CMS;
    (function (CMS) {
        var PostsRow;
        (function (PostsRow) {
            PostsRow.idProperty = 'Id';
            PostsRow.nameProperty = 'Status';
            PostsRow.localTextPrefix = 'CMS.Posts';
        })(PostsRow = CMS.PostsRow || (CMS.PostsRow = {}));
    })(CMS = CareXP.CMS || (CareXP.CMS = {}));
})(CareXP || (CareXP = {}));
var CareXP;
(function (CareXP) {
    ...
    (function (CMS) {
        ...
        (function (PostsService) {
            PostsService.baseUrl = 'CMS/Posts';
            [
                'Create',
                'Update',
                'Delete',
        ...
        })(PostsService = CMS.PostsService || (CMS.PostsService = {}));
    })(CMS = CareXP.CMS || (CareXP.CMS = {}));
})(CareXP || (CareXP = {}));
var CareXP;
(function (CareXP) {
    ...
    })(Common = CareXP.Common || (CareXP.Common = {}));
})(CareXP || (CareXP = {}));
var CareXP;
(function (CareXP) {
    var Common;
...
(function (CareXP) {
    ...
    })(Membership = CareXP.Membership || (CareXP.Membership = {}));
})(CareXP || (CareXP = {}));
var CareXP;
(function (CareXP) {
    var Membership;
...
(function (CareXP) {
    ...
    })(Northwind = CareXP.Northwind || (CareXP.Northwind = {}));
})(CareXP || (CareXP = {}));
var CareXP;
(function (CareXP) {
    var Northwind;
...
(function (CareXP) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'CareXP.Northwind.Gender', 'CareXP.Northwind.Entities.Gender');
    })(Northwind = CareXP.Northwind || (CareXP.Northwind = {}));
})(CareXP || (CareXP = {}));
var CareXP;
(function (CareXP) {
...
(function (CareXP) {
    ...
    (function (Authorization) {
        ...
        Authorization.CouldViewTenant = CouldViewTenant;
    })(Authorization = CareXP.Authorization || (CareXP.Authorization = {}));
})(CareXP || (CareXP = {}));
var CareXP;
(function (CareXP) {
    var LanguageList;
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = CareXP.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = CareXP.LanguageList || (CareXP.LanguageList = {}));
})(CareXP || (CareXP = {}));
...
(function (CareXP) {
    ...
    (function (ScriptInitialization) {
        ...
        Q.Config.rootNamespaces.push('CareXP');
        Serenity.EntityDialog.defaultLanguageList = CareXP.LanguageList.getValue;
        if ($.fn['colorbox']) {
            $.fn['colorbox'].settings.maxWidth = "95%";
            $.fn['colorbox'].settings.maxHeight = "95%";
        }
        window.onerror = Q.ErrorHandling.runtimeErrorHandler;
    })(ScriptInitialization = CareXP.ScriptInitialization || (CareXP.ScriptInitialization = {}));
})(CareXP || (CareXP = {}));
var CareXP;
(function (CareXP) {
    var Administration;
...
(function (CareXP) {
    ...
    (function (Administration) {
        var RoleDialog = /** @class */ (function (_super) {
            ...
            RoleDialog.prototype.afterLoadEntity = function () {
                ...
                if (this.isNew) {
                    ...
                    if (!CareXP.Authorization.hasPermission("Administration:Tenant:Modify")) {
                        this.form.TenantId.value = CareXP.Authorization.userDefinition.TenantId.toString();
                    }
                }
            };
            RoleDialog.prototype.getToolbarButtons = function () {
                ...
                if (!CareXP.Authorization.hasPermission("Administration:Role:Modify")) {
                    return [];
                }
        ...
        var RolePermissionDialog = /** @class */ (function (_super) {
            ...
            function RolePermissionDialog(opt) {
                ...
                Administration.RolePermissionService.List({
                    ...
                    _this.permissions.value = response.Entities.map(function (x) { return ({ PermissionKey: x }); }).filter(function (x) { return x.PermissionKey.search("Administration") > 0; });
                });
    ...
    (function (Administration) {
        var UserDialog = /** @class */ (function (_super) {
            ...
            UserDialog.prototype.getToolbarButtons = function () {
                ...
                if (CareXP.Authorization.hasPermission("Administration:Security")) {
    ...
    (function (Administration) {
        var PermissionCheckEditor = /** @class */ (function (_super) {
            ...
            function PermissionCheckEditor(container, opt) {
                ...
                var titleByKey = {};
                // Trả danh sách tên các PermissionKey được định nghĩa, và lấy về từ server
                var permissionKeys = _this.getSortedGroupAndPermissionKeys(titleByKey);
                // Khớp các lệnh được định nghĩa và các quyền thực tế mà user được cấp
            ...
            PermissionCheckEditor.prototype.getSortedGroupAndPermissionKeys = function (titleByKey) {
                // Lấy danh sách quyền được định nghĩa ở server
                var keys = Q.getRemoteData('Administration.PermissionKeys').Entities;
                var titleWithGroup = {};
                // Kiểm tra quyền của tài khoản đang dùng hiện tại
                var AllowSecuPermission = CareXP.Authorization.hasPermission('Administration:Security');
                for (var _i = 0, keys_1 = keys; _i < keys_1.length; _i++) {
                    ...
                    // Nếu tài khoản hiện thời không được quyền xem các quyền cao cấp, thì không cần
                    // hiển thị ra giao diện. Bỏ qua các quyền đó trong danh sách các quyền cần hiển thị
                    if (!AllowSecuPermission && s.match("Administration")) {
                        continue;
                    }
    ...
    (function (CMS) {
        var PostsDialog = /** @class */ (function (_super) {
            ...
            function PostsDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new CMS.PostsForm(_this.idPrefix);
                return _this;
            }
            PostsDialog.prototype.getFormKey = function () { return CMS.PostsForm.formKey; };
            PostsDialog.prototype.getIdProperty = function () { return CMS.PostsRow.idProperty; };
            PostsDialog.prototype.getLocalTextPrefix = function () { return CMS.PostsRow.localTextPrefix; };
            PostsDialog.prototype.getNameProperty = function () { return CMS.PostsRow.nameProperty; };
            PostsDialog.prototype.getService = function () { return CMS.PostsService.baseUrl; };
            PostsDialog = __decorate([
                Serenity.Decorators.registerClass()
            ], PostsDialog);
            return PostsDialog;
        }(Serenity.EntityDialog));
        CMS.PostsDialog = PostsDialog;
    })(CMS = CareXP.CMS || (CareXP.CMS = {}));
})(CareXP || (CareXP = {}));
var CareXP;
(function (CareXP) {
    ...
    (function (CMS) {
        var PostsGrid = /** @class */ (function (_super) {
            ...
            PostsGrid.prototype.getColumnsKey = function () { return 'CMS.Posts'; };
            PostsGrid.prototype.getDialogType = function () { return CMS.PostsDialog; };
            PostsGrid.prototype.getIdProperty = function () { return CMS.PostsRow.idProperty; };
            PostsGrid.prototype.getLocalTextPrefix = function () { return CMS.PostsRow.localTextPrefix; };
            PostsGrid.prototype.getService = function () { return CMS.PostsService.baseUrl; };
            PostsGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], PostsGrid);
            return PostsGrid;
        }(Serenity.EntityGrid));
        CMS.PostsGrid = PostsGrid;
    })(CMS = CareXP.CMS || (CareXP.CMS = {}));
})(CareXP || (CareXP = {}));
var CareXP;
(function (CareXP) {
    ...
    CareXP.BasicProgressDialog = BasicProgressDialog;
})(CareXP || (CareXP = {}));
var CareXP;
(function (CareXP) {
    var Common;
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new CareXP.BasicProgressDialog();
...
(function (CareXP) {
    ...
    })(DialogUtils = CareXP.DialogUtils || (CareXP.DialogUtils = {}));
})(CareXP || (CareXP = {}));
var CareXP;
(function (CareXP) {
    var Common;
...
(function (CareXP) {
    ...
    CareXP.StaticTextBlock = StaticTextBlock;
})(CareXP || (CareXP = {}));
var CareXP;
(function (CareXP) {
    var Common;
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                CareXP.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
    ...
    (function (Northwind) {
        var CustomerGrid = /** @class */ (function (_super) {
            ...
            CustomerGrid.prototype.getButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getButtons.call(this);
                buttons.push(CareXP.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    service: 'Northwind/Customer/ListExcel',
                    separator: true
                }));
                buttons.push(CareXP.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); }
                }));
                return buttons;
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(CareXP.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
                    cssClass: 'export-pdf-button',
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        CareXP.Common.ReportHelper.execute({
                            reportKey: 'Northwind.OrderDetail',
                            params: {
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: CareXP.Authorization.userDefinition.DisplayName,
...
(function (CareXP) {
    ...
    (function (Northwind) {
        ...
        }(CareXP.Common.GridEditorDialog));
    ...
    (function (Northwind) {
        var RegionDialog = /** @class */ (function (_super) {
            ...
            RegionDialog.prototype.getLanguages = function () {
                return CareXP.LanguageList.getValue();
            };
...
(function (CareXP) {
    ...
    (function (BasicSamples) {
        ...
        }(CareXP.Northwind.ProductDialog));
        ...
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: CareXP.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: CareXP.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new CareXP.Northwind.OrderDialog();
                        ...
                        var chai = CareXP.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = CareXP.Northwind.EmployeeRow.getLookup().items
...
(function (CareXP) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    CareXP.Northwind.CategoryService.Retrieve({
        ...
        }(CareXP.Northwind.CategoryDialog));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(CareXP.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new CareXP.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                CareXP.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(CareXP.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    CareXP.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(CareXP.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(CareXP.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    CareXP.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return CareXP.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return CareXP.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return CareXP.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return CareXP.Northwind.OrderService.baseUrl; };
...
(function (CareXP) {
    ...
    (function (BasicSamples) {
        ...
        }(CareXP.Northwind.SupplierDialog));
...
(function (CareXP) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    CareXP.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(CareXP.Northwind.CustomerDialog));
        ...
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.UnitPrice.value = CareXP.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                _this.form.Discount.addValidationRule(_this.uniqueName, function (e) {
                    var price = _this.form.UnitPrice.value;
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return CareXP.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return CareXP.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new CareXP.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(CareXP.Northwind.OrderDetailDialog));
...
(function (CareXP) {
    ...
    (function (BasicSamples) {
        ...
        }(CareXP.Northwind.OrderDetailsEditor));
...
(function (CareXP) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return CareXP.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return CareXP.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return CareXP.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return CareXP.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return CareXP.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (CareXP) {
    ...
    (function (BasicSamples) {
        ...
        }(CareXP.Common.BulkServiceAction));
...
(function (CareXP) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return CareXP.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return CareXP.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return CareXP.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return CareXP.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(CareXP.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new CareXP.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new CareXP.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new CareXP.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (CareXP) {
    ...
    CareXP.SelectableEntityGrid = SelectableEntityGrid;
})(CareXP || (CareXP = {}));
...
(function (CareXP) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return CareXP.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return CareXP.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return CareXP.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return CareXP.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(CareXP.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = CareXP.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            CareXP.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (CareXP) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return CareXP.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return CareXP.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return CareXP.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return CareXP.Northwind.ProductService.baseUrl; };
...
(function (CareXP) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return CareXP.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return CareXP.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return CareXP.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return CareXP.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (CareXP) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return CareXP.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return CareXP.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (CareXP) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return CareXP.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return CareXP.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return CareXP.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
//# sourceMappingURL=CareXP.Web.js.map