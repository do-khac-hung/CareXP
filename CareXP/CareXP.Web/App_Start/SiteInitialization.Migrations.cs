namespace CareXP
{
    ...
    { 
        ...
        private static void RunMigrations(string databaseKey)
        {
            ...
            /// Bởi vì sử dụng DatabaseName không theo qui định demo, nên phải bỏ qua
            ///  các kiểm tra này
            /*
            // safety check to ensure that we are not modifying an arbitrary database.
            // remove these lines if you want CareXP migrations to run on your DB.
            ...
            */
            ...
            using (var sw = new StringWriter())
            {
                ...
                var runner = new RunnerContext(announcer)
                {
                    ...
                    Namespace = "CareXP.Migrations." + databaseKey + "DB",
                    Timeout = 90
                };
